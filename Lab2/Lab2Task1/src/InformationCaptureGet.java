...
public class InformationCaptureGet extends HttpServlet {
	public void doGet(HttpServletRequest request,
        ...
        if (!isXMLAvailable(filepath)) {
        	...
        	output = readXML(response, filepath, firstname, lastname, days, location, languages);
	...
	private ArrayList<String> readXML(HttpServletResponse response, String filepath, String firstname, 
