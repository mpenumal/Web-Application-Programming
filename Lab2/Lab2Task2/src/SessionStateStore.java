...
public class SessionStateStore extends HttpServlet {
	public void doPost (HttpServletRequest request, HttpServletResponse response)
	        throws javax.servlet.ServletException, java.io.IOException {
		
			
		
		HttpSession sess = request.getSession(true);    // create the session
	        
			String firstname = request.getParameter("firstname");
		    String lastname = request.getParameter("lastname");
			
			Cookie loginCookie = new Cookie("user",firstname+'-'+lastname);
		    ...
		    ArrayList<ArrayList<String>> preferenceMatches = getPreferenceMatches(filepath, firstname, lastname);
